const unityApp = {
    ...
    startLoading: function () {
        ...
        const loaderUrl = buildUrl + "/build44.loader.js";
        const config = {
            arguments: [],
            dataUrl: buildUrl + "/build44.data.br",
            frameworkUrl: buildUrl + "/build44.framework.js.br",
            codeUrl: buildUrl + "/build44.wasm.br",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "DefaultCompany",
            productName: "BimkaMiniGames",
            productVersion: "0.1",
            showBanner: (msg, type) => {
                switch (type) {
                    case 'error': {
