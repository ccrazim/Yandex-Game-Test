...
(() => {
    ...
    var e = {
            ...
            404: (e, t, r) => {
                ...
                function c(e, t = {}) {
                    s("sdk-game", e, t), "warn" === t.level ? console.warn(e, n.X4) : "info" === t.level ? console.info((null == e ? void 0 : e.message) || e) : console.error(e, n.X4)
                }
            },
            526: (e, t, r) => {
                r.d(t, {
            ...
            292: (e, t, r) => {
                ...
                const n = 1e4;
                var a = (e => (e.CON = "CON", e.HOP = "HOP", e.TST = "TST", e.YAN = "YAN", e))(a || {}),
    ...
    (() => {
        ...
        class D {
            constructor(e) {
                ...
                this.callbacks = {}, this.onAdvDebugManagerExternalMessage = e => {
                    ...
                    switch (C(`onAdvManagerExternalMessage ${g}`), g) {
                        ...
                        case "set-disabled-state":
                            C('On "set-disabled-state" event', e.data, y.value), this.setDisabledState(y.value)
                    }
            ...
            showFullscreenAdvDebug(e) {
                this.showFullscreenAdv({
                    callbacks: {
                        onClose: t => C(`${e} onClose, wasShown = ${t}`),
                        onError: t => C(`${e} onError, error =`, t),
                        onOpen: () => C(`${e} onOpen`)
                    }
                })
            }
            ...
            switchStickyBannersDebug(e) {
                this.getBannerAdvStatus().then((({
                    ...
                    t ? this.hideBannerAdv().then((({
                        ...
                        C(`${e} hideBannerAdv, stickyAdvIsShowing = ${t}`)
                    })) : this.showBannerAdv().then((({
                        reason: t,
                        stickyAdvIsShowing: r
                    }) => {
                        C(`${e} hideBannerAdv, stickyAdvIsShowing = ${r}, reason = ${t}`)
                    }))
                }))
            }
            updateDisabledState() {
            ...
            setDisabledState(e) {
                C("setDisabledState", e), e ? A || (A = !0, S("_disableAds"), function() {
                    var e;
                    ...
                    "function" == typeof(null == (r = null == (t = null == (e = window.Ya) ? void 0 : e.Context) ? void 0 : t.AdvManager) ? void 0 : r.render) && (window.Ya.Context.AdvManager.render = n.render), T();
                    let a = window.Ya;
                    Object.defineProperty(window, "Ya", {
                        get() {
                            var e;
                            return (null == (e = null == a ? void 0 : a.Context) ? void 0 : e.AdvManager) && a.Context.AdvManager !== n && (a.Context.AdvManager = n), T(), a
                        },
                        set(e) {
                            var t;
            ...
            showFullscreenAdv({
                ...
                l.F.postToParent(i.X$.AdvShowFullscreen()).then((({
                    ...
                    const r = function(e) {
                        return (e instanceof Error ? e.message : String(e)).includes("Fullscreen ad skipped: too frequent requests") ? "info" : "warn"
                    }(t);
                    (0, m.T)(t, {
                        level: r
                    }), I(e, "onError")(t), I(e, "onClose")(!1), this.callDeprecatedOnClose(!1)
                })).finally((() => {
                    t()
                }))
            }
            showRewardedVideo({
                ...
                l.F.postToParent(i.X$.AdvShowRewardedVideo()).then((({
                    ...
                    (0, m.f)(t), I(e, "onError")(t), I(e, "onClose")(!1)
                })).finally((() => {
                    t()
                }))
            }
        ...
        let F = () => (window.YandexGamesSDKEnvironment || (0, m.f)(new Error("SDK environment: `window.YandexGamesSDKEnvironment` is undefined")), F = () => window.YandexGamesSDKEnvironment || N, F());
        const G = {
                get app() {
                    return F().app
                },
                ...
                get domain() {
                    return F().serviceName || F().serviceHostname
                }
            },
            j = r(69).Z,
            $ = {
                small: L.f9.ISLANDS_RETINA_SMALL,
                medium: L.f9.ISLANDS_RETINA_MEDIUM,
                large: L.f9.ISLANDS_200
            },
            M = {
                small: L.f9.ISLANDS_200,
                medium: L.f9.ISLANDS_200,
                large: L.f9.BIG
            },
            U = {
                sdkBackendURL: "",
            ...
            B = `${U.avatarOrigin}/get-yapic/`;
        class V {
            constructor(e) {
                this._personalInfo = e
            }
            getID() {
                return (0, m.T)(new Error("Player.getID() is deprecated. Please, use Player.getUniqueID().\nhttps://yandex.ru/dev/games/doc/dg/sdk/sdk-player.html#sdk-player__profile-data")), j.sendOnceDeprecatedUsage("Player.getID"), this._personalInfo.id
            }
            getUniqueID() {
            ...
            getMode() {
                var e;
                return (0, m.T)(new Error("Player.getMode() is deprecated. Please, use Player.isAuthorized().\nhttps://yandex.ru/dev/games/doc/dg/sdk/sdk-player#auth")), j.sendOnceDeprecatedUsage("Player.getMode"), null != (e = this._personalInfo.mode) ? e : ""
            }
            getPayingStatus() {
            ...
            getPhoto(e = "medium") {
                ...
                return this._personalInfo.avatarIdHash ? `${U.sdkBackendURL}/player/avatar/${this._personalInfo.avatarIdHash}/${t}` : `${B}${L._h}/${t}`
            }
            isAuthorized() {
        ...
        class K {
            ...
            set dataHash(e) {
                this._dataHash = e ? K.stringifyData(e) : null
            }
            set timestamp(e) {
                this._timestamp = e
            }
            validate(e) {
                const t = K.stringifyData(e);
                return K.byteLength(t) > 204800 ? {
        ...
        var H = Object.defineProperty,
            ...
            J = (e, t) => {
                for (var r in t || (t = {})) q.call(t, r) && z(e, r, t[r]);
                if (W)
                    for (var r of W(t)) X.call(t, r) && z(e, r, t[r]);
                return e
            };
        const Q = (e, t) => {
        ...
        l.F.onExternalMessage("auth", (e => {
            if ("changed" === e.data.action && ie) {
                ee("Call onLogoutCallback()");
                try {
                    ie()
                } catch (e) {
                    console.error()
        ...
        class ce extends V {
            constructor(e, t) {
                super(e), this.dataPromise = null, this.getApiPromise = () => new Promise(((e, t) => {
                    ...
                    var e, t
                }, this.getDataPromise = () => void 0 !== this.data ? Promise.resolve(this.data) : G.isTelegram ? (Q("getData", {
                    key: Z
                }), new Promise(((e, t) => {
                    function r(n) {
                        var a;
                ...
                }))).catch((() => this.getPlayerData())) : this.getApiPromise(), this.config = t, se && se.isSamePlayer(this.getUniqueID()) || (se = new K(this.getUniqueID()))
            }
            onLogout(e) {
                ee("Set onLogout callback"), ie = e
            }
            getIDsPerGame() {
            ...
            getData(e) {
                return this.dataPromise = this.getDataPromise(), this.dataPromise.then((t => ne(t, e)))
            }
            setData(e, t = !1) {
                var r;
                if (G.isTelegram && (r = e, Q("setData", {
                        key: Z,
                ...
                const n = function(e, t = !1) {
                    const r = se.validate(e);
                    return r.error ? r.reject ? Promise.reject(r.error) : ((0, m.T)(r.error), Promise.resolve(!0)) : new Promise(((r, n) => {
                        oe && window.clearTimeout(oe);
                        let a = t ? 200 : Math.max(200, se.getWaitTime());
                        se.timestamp = Date.now(), oe = window.setTimeout((() => {
                            l.F.postToParent(i.Uh.SetData({
                                data: e
                            })).then((() => {
                                se.dataHash = e, r(!0)
                            })).catch((e => {
                                se.timestamp = 0, se.dataHash = null, n(e)
                            }))
                        }), a)
                    }))
                }(e, t);
            ...
            getStats(e) {
                return void 0 === this.statsPromise && (this.statsPromise = new Promise(((e, t) => {
                    l.F.postToParent(i.Uh.Stats({
                        ...
                        data: e
                    }) => re(e))).then(e).catch(t).finally((() => this.statsPromise = void 0))
                }))), this.statsPromise.then((t => ne(t, e)))
            }
            setStats(e) {
                return ae(e) ? l.F.postToParent(i.Uh.SetStats({
                    stats: e
                })).then((({
                    data: e
            ...
            incrementStats(e) {
                return ae(e) ? l.F.postToParent(i.Uh.IncrementStats({
                    increments: e,
                    signed: this.config.signed
                })).then((({
                    data: e
                }) => re(e.result))) : Promise.reject(new Error("Increments is not valid"))
            }
        }
        const le = new Set;
        let de = !1;
        const ue = "function" != typeof Proxy ? e => e : (e, t, r) => de ? e : new Proxy(e, {
                get: (e, n) => ("symbol" != typeof n && !de && t.includes(n) && le.add(`${r}.${n}`), e[n])
            }),
            he = () => {
                de || (l.F.postToParent((0, i.Iq)(Array.from(le).join(","))), le.clear(), de = !0)
            },
            pe = h("PlayerProxy"),
            me = new _;
        ...
        function ge() {
            return e = this, t = arguments, r = function*(e = {}) {
                var t;
                const r = null == (t = me.getFor(e)) ? void 0 : t.promise;
                if (r) return r;
                const n = y("getPlayer", 12e4),
                    a = new p;
                return a.promise.finally((() => {
                    n()
                })), me.setFor(e, a), window.setTimeout((() => {
                    me.setFor(e, void 0)
                    ...
                    const {
                        ...
                        const n = new ce(t, e);
                        return x(n, r), ue(n, ["getPayingStatus", "getStats", "getData", "getName"], "Player")
                    }(e, r, n);
                    a.resolve(o)
                })).catch((t => {
                    me.setFor(e, void 0), a.reject(t)
                })), a.promise
            }, new Promise(((n, a) => {
                var o = e => {
                        try {
        ...
        function ye() {
            pe("Clear getPlayer promises."), me.clear()
        }
        l.F.onExternalMessage("auth", (e => {
            ["auth-dialog-cancel", "auth-dialog-success", "changed"].includes(e.data.action) && ye()
        }));
        const fe = new class {
            openAuthDialog() {
        ...
        var we = Object.defineProperty,
            ...
            Te = (e, t, r) => t in e ? we(e, t, {
                enumerable: !0,
                configurable: !0,
                writable: !0,
                value: r
            }) : e[t] = r;
        const Ae = s((e => l.F.postToParent(i.S.Score(e)).then((({
            data: e
        }) => e.result))), 1e3);
        class ke {
            ...
            setLeaderboardScore(e, t, r) {
                ...
                return this.lastTimeLeaderboardWasSend && !this.canSetLeaderboardScoreByTime() ? Promise.reject("The request to setLeaderboardScore can be sent no more than once per second") : (r && (n.extraData = r), this.lastTimeLeaderboardWasSend = Date.now(), Ae(n))
            }
            ...
            transformLeaderboardEntry(e, t) {
                ...
                return c = ((e, t) => {
                    for (var r in t || (t = {})) Se.call(t, r) && Te(e, r, t[r]);
                    if (Ee)
                        for (var r of Ee(t)) Oe.call(t, r) && Te(e, r, t[r]);
                    return e
                })({}, e), be(c, Pe({
                    player: {
                        getAvatarSrc: (e = "medium") => ($[e] || (e = "medium"), `${i}/${$[e]}`),
                        getAvatarSrcSet: (e = "medium") => ($[e] || (e = "medium"), `${i}/${$[e]} 1x, ${i}/${M[e]} 2x`),
                        lang: n,
                        publicName: a,
                        scopePermissions: o,
                        uniqueID: s
        ...
        const Ce = () => {
            (0, m.T)(new Error("ysdk.getLeaderboards() is deprecated. Please, use ysdk.leaderboards.\nhttps://yandex.ru/dev/games/doc/dg/sdk/sdk-leaderboard")), j.sendOnceDeprecatedUsage("ysdk.getLeaderboards()");
            const e = new ke;
        ...
        class Ie extends Error {
            constructor({
                ...
                super(r, n, a), this.name = "PaymentsError", this.code = e, this.httpStatus = t, Object.setPrototypeOf(this, Ie.prototype), Error.captureStackTrace && Error.captureStackTrace(this, Ie)
            }
            toJSON() {
                return {
                    code: this.code,
        ...
        const De = Ie,
            _e = new Set(["ru", "uk", "be", "kk", "uz"]);
        var xe = (e => (e.BE = "be", e.EN = "en", e.KK = "kk", e.RU = "ru", e.TR = "tr", e.UK = "uk", e.UZ = "uz", e))(xe || {});
        const Le = xe.RU;
        ...
        function Re(e, t = Le, r = "") {
            if (e) {
                ...
                if (!(e => !e || _e.has(e))(t) && "en" in e) return e.en || r;
                if (Le in e) return e[Le] || r
            }
            return r
        }
        var Ne;
        const Fe = Symbol("codePath"),
            Ge = Symbol("appId"),
            je = Symbol("sendMetricaParams"),
            $e = Symbol("currencyPriceStat"),
            Me = Symbol("sendOnceCurrencyCodeStat"),
            Ue = Symbol("getCurrencyImageUrlPrefix"),
            Be = Symbol("currencyCodeStat");
        class Ve {
            constructor(e) {
                this._productData = e, this[Ne] = () => {
                    this[Me] = () => {}, this[je](this[Be])
                }
            }
            get id() {
            ...
            get title() {
                return Re(this._productData.title)
            }
            get description() {
                return Re(this._productData.description)
            }
            get imageURI() {
                const {
                    image: e
            ...
            getPriceCurrencyImage(e = "small") {
                if ("svg" === e) return `${this[Ue]()}/currency-icon-m.svg`;
                let t = "s";
                switch (e) {
                    case "medium":
                    case "small":
                ...
                return `${this[Ue]()}/currency-icon-${t}${r?"@2x":""}.png`
            }
            toJSON() {
                return {
                    id: this.id,
            ...
            get[Be]() {
                ...
                return `//yastatic.net/s3/games-static/static-data/images/payments/sdk${this[Fe]}`
            }
            get[$e]() {
        ...
        class He extends Ve {
            get priceCurrencyCode() {
                var e;
                return super.priceCurrencyCode, this[$e] ? this[$e].currency : null == (e = window.YandexGamesSDKEnvironment) ? void 0 : e.moneyCodeSymbol
            }
            get price() {
                return `${this.priceValue} ${this.priceCurrencyCode}`
            }
            get priceValue() {
                return this[$e] ? String((e => {
                    const t = e / L.Uo;
                    return Math.ceil(100 * t) / 100
                })(this[$e].priceValue)) : super.priceValue
            }
            get[Fe]() {
                var e, t;
                return this[$e] ? `/${this[$e].currency.toLowerCase()}` : (null == (e = window.YandexGamesSDKEnvironment) ? void 0 : e.moneyCodeSymbol) ? `/${null==(t=window.YandexGamesSDKEnvironment)?void 0:t.moneyCodeSymbol.toLowerCase()}` : ""
            }
            get [Ge]() {
                return (0, Ye.o)()
            } [je](e) {
        ...
        var qe = Object.defineProperty,
            ...
            tt = (e, t) => {
                ...
                if (Je)
                    for (var r of Je(t)) Ze.call(t, r) && et(e, r, t[r]);
                return e
            },
            rt = (e, t) => Xe(e, ze(t));
        const nt = h("Payment");
            ...
            getCatalog() {
                return new Promise(((e, t) => {
                    ...
                    l.F.postToParent(i.yH.GetCatalog({
                        ...
                        nt("get-catalog result", t), e(t.products.map((e => new He(e))))
                    })).catch((e => {
                        t(e)
                    })).finally((() => {
                        r()
            ...
            purchase(e) {
                ...
                return new Promise(((t, r) => {
                    l.F.postToParent(i.yH.PurchaseStart({
                        paymentsConfig: rt(tt({}, this._config), {
                            lang: G.i18n.lang
                        }),
                        purchaseConfig: e
                    })).then((({
            ...
            consumePurchase(e) {
                return new Promise(((t, r) => {
                    ...
                    l.F.postToParent(i.yH.PurchaseConsume({
                        ...
                        if (console.info("consumePurchase data"), console.info(e), !e || !e.token) throw new De({
        ...
        let it;
        try {
            it = window.localStorage
        } catch (e) {}
        const ct = it || function() {
                let e = {};
                return {
                    clear() {
                        e = {}
            ...
            dt = /^((?!chrome|android).)*safari/i.test(navigator.userAgent),
            ut = lt || dt,
            ht = /app-[^.]+\.games\.s3\.yandex\.net$/.test(location.hostname),
            pt = !ht && ut,
            mt = function(e, t) {
            ...
            gt = class e {
                static setup() {
                    pt && Object.defineProperty(window, "localStorage", {
                        get: function() {
                            return mt(), ct
                        }
                    }), ut && ht && e.setProxy() && e.backup()
                }
                static load() {
                    if (e.onloadPromise_) return e.onloadPromise_;
                    const t = e.getCustomLocalStorage();
                    return t ? (e.onloadPromise_ = Promise.race([st(5e3).then((() => {
                        ...
                        return t
                    }))]).catch((e => (console.error(e), ct))), e.onloadPromise_) : Promise.resolve(ct)
                }
                static getCustomLocalStorage() {
                    return "function" != typeof Proxy ? null : new Proxy({
                        clear() {
                            ct.clear.call(ct), l.F.postToParent(i.Qq.Clear())
                        },
                        getItem: e => ct.getItem.call(ct, e),
                        key: e => ct.key.call(ct, e),
                        get length() {
                            return ct.length
                        },
                        removeItem(e) {
                            ct.removeItem.call(ct, e), l.F.postToParent(i.Qq.Del(e))
                        },
                        setItem(e, t) {
                            ct.setItem.call(ct, e, String(t)), l.F.postToParent(i.Qq.Set(e, t))
                        }
                    }, {
                        get: function(e, t) {
        ...
        gt.onloadPromise_ = null;
        let yt = gt;

        function ft() {
            return !ut && it ? Promise.resolve(it) : yt.load()
        }
        var vt = Object.defineProperty,
            ...
            Tt = (e, t) => {
                for (var r in t || (t = {})) Et.call(t, r) && Ot(e, r, t[r]);
                if (Pt)
                    for (var r of Pt(t)) St.call(t, r) && Ot(e, r, t[r]);
                return e
            };
        const At = e => ({
            get id() {
        ...
        var kt = Object.defineProperty,
            ...
            Rt = (e, t) => {
                ...
                if (Dt)
                    for (var r of Dt(t)) xt.call(t, r) && Lt(e, r, t[r]);
                return e
            },
            Nt = (e, t) => Ct(e, It(t)),
            Ft = (e, t, r) => new Promise(((n, a) => {
                var o = e => {
                        try {
                            i(r.next(e))
                        } catch (e) {
        ...
        const Gt = () => ({
            ...
            jt = class {
                constructor(e) {
                    this.getCatalog = () => Ft(this, null, (function*() {
                        var e;
                        const {
                            data: t
                        } = yield l.F.postToParent(i.Aw.Catalog(Gt()));
                        return (null != (e = null == t ? void 0 : t.bonuses) ? e : []).map(At)
                    })), this.getPlayerBonuses = () => Ft(this, null, (function*() {
                        const {
                            data: e
                        } = yield l.F.postToParent(i.Aw.PlayerBonuses(Nt(Rt({}, Gt()), {
                            signed: this.signed
                        })));
                        return this.signed ? e : e ? e.map((e => Nt(Rt({}, At(e.item)), {
        ...
        function Bt(e) {
            ...
            if ("DIV" === e.tagName && e.getAttribute("style") && !e.querySelector("div") && !e.classList.length && !e.id) {
                ...
                e && (Ut(`popup message = ${e}`), l.F.postToParent((0, i.Bz)({
        ...
        function Vt() {
            ...
            if (Ut("captureUnityAlert isUnity", e), e && (document.querySelectorAll("div[style]:not([id]):not([class])").forEach(Bt), "undefined" != typeof MutationObserver)) {
                const e = new MutationObserver((e => {
                    e.forEach((e => {
                        "childList" === e.type && setTimeout((() => {
                            Array.from(e.addedNodes).forEach(Bt)
                        }), 0)
                    }))
                }));
        ...
        var Ht = r(934),
            ...
            Qt = (e, t) => {
                for (var r in t || (t = {})) Xt.call(t, r) && Jt(e, r, t[r]);
                if (qt)
                    for (var r of qt(t)) zt.call(t, r) && Jt(e, r, t[r]);
                return e
            };
        ...
        var tr = Object.defineProperty,
            ...
            sr = (e, t) => {
                for (var r in t || (t = {})) nr.call(t, r) && or(e, r, t[r]);
                if (rr)
                    for (var r of rr(t)) ar.call(t, r) && or(e, r, t[r]);
                return e
            };
        ...
        const lr = new class {
            ...
            _unsafeHandleErrorEvent(e, t) {
                ...
                (this.additionalErrorData || (null == i ? void 0 : i.additional)) && (c.additional = sr(sr({}, null == i ? void 0 : i.additional), this.additionalErrorData)), console.error(c.message, L.X4, c), this._postError(c, t)
            }
            _trimErrorData(e, t) {
            ...
            function() {
                try {
                    ...
                    console.error = (...t) => {
                        ...
                        try {
                            "string" == typeof t[1] && t[1] === L.X4 ? t.splice(1, 1) : ir(cr(r), "console.error")
                        } catch (e) {}
                        e.apply(console, t)
                    }
                } catch (e) {
        ...
        var dr = Object.defineProperty,
            ...
            yr = (e, t, r) => t in e ? dr(e, t, {
                enumerable: !0,
                configurable: !0,
                writable: !0,
                value: r
            }) : e[t] = r;
        const fr = h("Events bus", "Dev", {
                background: "#0072B5",
                text: "#ffffff"
            }),
            vr = new f(fr),
            wr = [c.US, c.Tn, c.Ul],
            br = e => l.F.postToParent(i._W.ListenersChange({
                event: e,
                count: vr.getObserversNumber(e)
            })),
            Pr = {
                EXIT: br,
                HISTORY_BACK: br,
                ACCOUNT_SELECTION_DIALOG_OPENED: br,
                ACCOUNT_SELECTION_DIALOG_CLOSED: br
            },
            Er = (Sr = ((e, t) => {
                for (var r in t || (t = {})) mr.call(t, r) && yr(e, r, t[r]);
                if (pr)
                    for (var r of pr(t)) gr.call(t, r) && yr(e, r, t[r]);
                return e
            })({}, Pr), Or = {
                [c.Wu.Pause]: function(e, t) {
                    return r = this, n = function*() {
                        var r;
                        const n = yield br(e);
                        (null == (r = null == n ? void 0 : n.data) ? void 0 : r.isPaused) && t()
                    }, new Promise(((e, t) => {
                        var a = e => {
                                try {
                                    s(n.next(e))
        ...
        const Tr = (e, t) => {
                var r;
                fr(`[on]: {${e}}`);
                const n = vr.subscribe(e, t);
                return null == (r = Er[e]) || r.call(Er, e, t), () => {
                    var r;
                    n(), null == (r = Pr[e]) || r.call(Pr, e, t)
                }
            },
            Ar = (e, t) => {
                var r;
                fr(`[off]: {${e}}`), vr.unsubscribe(e, t), null == (r = Pr[e]) || r.call(Pr, e, t)
            },
            kr = (e, t) => {
                fr(`[notifyObservers]: {${e}}`, ...t ? [t] : []), vr.notifyObservers(Array.isArray(e) ? e : [e], t)
            };
        l.F.onExternalMessage(wr, (({
            data: {
                action: e,
                data: t
            }
        }) => kr(e, t)));
        const Cr = h("Gameplay | Child frame", "Dev", {
                background: "#6c5b7b",
                text: "#ffffff"
            }),
            Ir = e => {
                Cr(`[POST]: {${e}}`), l.F.postToParent((0, i.$J)(e))
            };
        var Dr;
        const _r = "/helpers/fake-page/1/index.html",
            xr = Symbol("promises");
        Dr = xr;
        let Lr = class e {
            constructor() {
                if (this[Dr] = new Map, e.instance) return e.instance
            }
            getAllGames() {
                const e = this[xr].get("all");
                if (e) return e;
                const t = y("getAllGames"),
                    r = new Promise(((e, r) => l.F.postToParent(i.Rh.All({
                        ...
                        var r;
                        (null == (r = window.YandexGamesSDKEnvironment) ? void 0 : r.useMockGameLinks) && (t.games.forEach((e => e.url = `${_r}`)), t.developerURL = `${_r}`), e(t)
                    })).catch((e => {
                        this[xr].delete("all"), r(e)
                    })).finally((() => t()))));
                return this[xr].set("all", r), r
            }
            getGameByID(e) {
                const t = this[xr].get(`${e}`);
                if (t) return t;
                const r = y("getGameByID"),
                    n = new Promise(((t, n) => l.F.postToParent(i.Rh.Game({
                        ...
                        var r;
                        (null == (r = window.YandexGamesSDKEnvironment) ? void 0 : r.useMockGameLinks) && e.game && (e.game.url = `${_r}`), t(e)
                    })).catch((t => {
                        this[xr].delete(`${e}`), n(t)
                    })).finally((() => r()))));
                return this[xr].set(`${e}`, n), n
            }
        };
        Lr.instance = ue(new Lr, ["getGameByID", "getAllGames"], "GamesAPI");
        const Rr = Lr.instance,
            Nr = class e {
                constructor() {
        ...
        class $r {
            constructor(e = {}) {
                this[Gr] = Rr;
                for (let t in c.VR) c.VR[t] in e && e[c.VR[t]] && (this[t] = new jr[t]);
                for (let t of c.Hn) !this[t] && (t in e && e[t] || !(t in e)) && (this[t] = new jr[t]);
                l.F.postToParent((0, i.OI)(c.ur.GameInit))
            }
        }
        c.VR.GameplayAPI, c.VR.LoadingAPI, c.VR.PluginEngineDataReporterAPI, Gr = c.VR.GamesAPI;
        var Mr = (e => (e.GAME_RATED = "GAME_RATED", e.NO_AUTH = "NO_AUTH", e.REVIEW_ALREADY_REQUESTED = "REVIEW_ALREADY_REQUESTED", e.REVIEW_WAS_REQUESTED = "REVIEW_WAS_REQUESTED", e.UNKNOWN = "UNKNOWN", e))(Mr || {});
        const Ur = new class {
            canReview() {
                return new Promise((e => {
        ...
        function Kr() {
            const e = [],
                t = {
                    ...
                    webgl: Br(document.createElement("canvas")),
                    webgl2: Vr(document.createElement("canvas"))
                };
        ...
        var Hr, Wr = r(179),
            qr = ((Hr = qr || {}).Finish = `${c.vA}-sessions-finish`, Hr.Transaction = `${c.vA}-sessions-transaction`, Hr),
            Xr = Object.defineProperty,
            zr = Object.getOwnPropertySymbols,
            Jr = Object.prototype.hasOwnProperty,
            Qr = Object.prototype.propertyIsEnumerable,
            Zr = (e, t, r) => t in e ? Xr(e, t, {
                enumerable: !0,
                configurable: !0,
                writable: !0,
                value: r
            }) : e[t] = r,
            en = (e, t, r) => new Promise(((n, a) => {
                var o = e => {
                        try {
                            i(r.next(e))
                        } catch (e) {
        ...
        const tn = h("Multiplayer Sessions | Child frame", "Dev", {
                background: "#b55a30",
                text: "#ffffff"
            }),
            rn = ({
                ...
                "transaction" === e ? kr(qr.Transaction, t) : "finish" === e && kr(qr.Finish, t)
            };
        class nn {
            constructor() {
                l.F.onExternalMessage(c.vA, rn)
            }
            commit(e) {
                l.F.postToParent(Wr.T.Commit(e))
            }
            init() {
                return en(this, arguments, (function*(e = {}) {
                    const t = ((e, t) => {
                        ...
                        if (zr)
                            for (var r of zr(t)) Qr.call(t, r) && Zr(e, r, t[r]);
                        return e
                    })({
                        isEventBased: !0
                    }, e);
                    return tn("[init]", t), t.meta && 0 === t.count || tn("[init] NOTE: multiplayer was initialized for recording only: {meta} or {count} parameters were not provided."), (yield l.F.postToParent(Wr.T.Init(t))).data
                }))
            }
            push(e) {
                return en(this, null, (function*() {
                    return l.F.postToParent(Wr.T.Push(e))
                }))
            }
        }
        const an = {
        ...
        function on(...e) {
            ...
            return e.reduce(((e, r) => (Object.keys(r).forEach((n => {
                const a = e[n],
                    o = r[n];
                Array.isArray(a) && Array.isArray(o) ? e[n] = a.concat(...o) : t(a) && t(o) ? e[n] = on(a, o) : e[n] = o
            })), e)), {})
        }
        ...
        function sn(e, t = {}) {
            ...
            return (null == (n = null == (r = window.YandexGamesSDKEnvironment) ? void 0 : r.request.experiments) ? void 0 : n.signed) && (t.signed = !0),
                ...
                function(e = {}) {
                    return function(e) {
                        "adv" in e && j.sendOnceDeprecatedUsage("SDK init options with adv"), e.adv = e.adv || {},
                            function(e) {
        ...
        const dn = class {
            constructor(e) {
                this.payments = null, this.initPromise = null, this.getCatalog = () => ln(this, null, (function*() {
                    return (yield this.ensureInitialized()).getCatalog()
                })), this.purchase = e => ln(this, null, (function*() {
                    return (yield this.ensureInitialized()).purchase(e)
                })), this.getPurchases = () => ln(this, null, (function*() {
                    return (yield this.ensureInitialized()).getPurchases()
                })), this.consumePurchase = e => ln(this, null, (function*() {
                    return (yield this.ensureInitialized()).consumePurchase(e)
                })), this.signed = Boolean(e)
            }
            ensureInitialized() {
                return ln(this, null, (function*() {
                    return this.payments ? this.payments : (this.initPromise || (this.initPromise = ot({
                        signed: this.signed
        ...
        class pn {
            constructor() {
                this.fullscreen = new hn
            }
        }
        var mn = r(7);
        const gn = Date.now(),
            yn = `id_cursorHighlighter_${gn}`,
            fn = `cursorHighlighter_${gn}`,
            vn = `active_${gn}`,
            wn = {
                [c.q1.EXIT]: !0
            },
            bn = ["passport.ya", "passport.yandex", "an.yandex.ru", "avatars.mds.yandex.net", "/api/"];

        function Pn(e) {
            const t = Cache.prototype[e];
            Cache.prototype[e] = function(e, r) {
                return "GET" !== e.method || 0 !== e.url.indexOf("https://") || (n = e.url, bn.some((e => -1 !== n.indexOf(e)))) ? Promise.resolve() : ("ignoreSearch" in (r = r || {}) || (r.ignoreSearch = !0), t.call(this, e, r));
                var n
            }
        }
        const En = class {
                static overrideCacheSearch() {
                    ("function" != typeof Cache ? (console.warn("Can not find `Cache` function"), 0) : "function" != typeof Cache.prototype.match ? (console.warn("Can not find `Cache.match` function"), 0) : "function" == typeof Cache.prototype.matchAll || (console.warn("Can not find `Cache.matchAll` function"), 0)) && (Pn("match"), Pn("matchAll"))
                }
            },
            Sn = new class {
                canShowPrompt() {
        ...
        function An(e = {}) {
            ...
            return o.promise.finally((() => {
                a()
            })), Tn.setFor(e, o), l.F.postToParent(i.XT.Fetch({
                clientFeatures: t
            })).then((({
                data: e
            }) => {
                ...
                o.resolve(r), Tn.setFor(e, void 0)
            })), o.promise
        }
        class kn {
            reachGoal(e, t, r) {
            ...
            In = e => {
                ...
                "function" == typeof n && (window.ym.a.push = function(...t) {
                    ...
                    if (e.metrikaCounter && "reachGoal" === o && s) {
                        ...
                        Cn.reachGoal(e.metrikaCounter, t, r)
                    }
                    return n.apply(this, t)
                })
            };
        var Dn = (e, t, r) => new Promise(((n, a) => {
            var o = e => {
                    try {
                        i(r.next(e))
                    } catch (e) {
        ...
        ! function() {
            var e;
            if (Mt()) Ut("alert hook disabled");
            else try {
                "function" == typeof window.alert && (e = window.alert, window.alert = function() {
                    const t = arguments[0];
                    return Ut(`alert message = ${t}`), l.F.postToParent((0, i.Bz)({
                        message: t.substring(0, 250)
                    })), e.apply(this, arguments)
                }), window.addEventListener("load", Vt, {
                    once: !0
                }), Ut("alert hook enabled")
            } catch (e) {
                (0, m.f)(e, {
        ...
        const Nn = Ln(void 0, null, (function*() {
            return function({
                staticOrigin: r,
                version: n,
                logError: s
            ...
            (() => {
                ...
                if (!n) return;
                let a;
                a = /games\.s3\.yandex\.net$/.test(t) ? `https://yandex.ru/games/app/${n}${r}${e}` : `https://yandex.com/games/app/${n}${r}${e}`, window.top.location.replace(a)
            })(), l.F.postToParent((0, i.Ry)({
                    url: location.href,
                    draftDetectedInIframe: Mt()
                    ...
                    l.F.postToParent((0, i.VT)()).then((({
                        ...
                        U.sdkBackendURL = String(t.enviroment.sdkBackendURL), Object.freeze(U), delete t.enviroment.sdkBackendURL, e(t)
                    })).catch((e => {
                        t(e)
                    })).finally((() => {
                        r()
                    ...
                    const t = !("enviroment" in e && "options" in e),
                        r = t ? e : e.enviroment;
                    return window.YandexGamesSDKEnvironment = r, In(r), Rn("APP_VERSION", r.APP_VERSION), !t && e.options
                })),
                function() {
        ...
        class jn {
            constructor(e) {
                ...
                e = sn(e), this.EVENTS = {
                ...
                }, this.onEvent = (e, t) => (console.warn("Deprecated usage of `ysdk.onEvent`, please use `ysdk.on(...)` instead."), Tr(e, t)), this.achievements = P.init(), this.adv = ue(new D(e), ["showBannerAdv"], "AdvManager"), this.analytics = {
                    yaMetrikaCounter: ue(new kn, ["hit", "reachGoal"], "YaMetrikaCounter")
                }, this.auth = fe, this.bonuses = $t.init(e.signed), this.clipboard = Yt, this.deviceInfo = new Kt(e.deviceType), Mn.deviceInfo = this.deviceInfo, this.environment = (e => {
                    ...
                    return Object.defineProperty(t, "i18n", {
                        get() {
                            const t = e.i18n;
                            return new Proxy(t, {
                                get: (e, t) => ("lang" === t && l.F.postToParent(Y.i.I18n()), e[t])
                            })
                        }
                    }), t
                })(G), this.feedback = Ur, this.isAvailableMethod = (r = this, e => {
                    const t = y("isAvailableMethod"),
                        n = l.F.postToParent(i.sC.CheckAvailability({
                            ...
                            const a = {
                                    ...
                                    payments: at,
                                    player: ce,
                                    storage: yt.getCustomLocalStorage()
                                },
                                o = e.split(".");
                            let s = (i = Tt(Tt({}, a), r), c = {
                                leaderboards: Tt({
                                    getLeaderboardDescription: ke.prototype.getLeaderboardDescription,
                                    getLeaderboardEntries: ke.prototype.getLeaderboardEntries,
                                    getLeaderboardPlayerEntry: ke.prototype.getLeaderboardPlayerEntry,
                                    setLeaderboardScore: ke.prototype.setLeaderboardScore
                                }, r.leaderboards)
                            }, wt(i, bt(c)));
                            var i, c;
                            for (let e = 0; e < o.length; e++) {
                                ...
                                if (!ve(t)) return !1;
                                s = ve(t.prototype) ? t.prototype : t
                            }
                            return !1
                        }));
                    return n.finally((() => {
                ...
                }), this.shortcut = Sn, this.getPlayer = ge, this.getStorage = ft, this.multiplayer = (() => {
                    const e = new nn;
                    return {
                        get sessions() {
                            return e
                ...
                })(), this.notifications = an, this.getLeaderboards = Ce, this.leaderboards = xn.init(), this.getPayments = cn, this.payments = un.init(e.signed), this.screen = new pn, this.features = ue(new $r(e.features), [c.VR.GameplayAPI, c.VR.LoadingAPI], "FeatureManager"), this.yandexApp = {
                ...
                }(), this.getFlags = An, this.dispatch = kr, this.on = Tr, this.off = Ar
            }
        }
        ...
        try {
            Gn = new URLSearchParams(location.hash.slice(1)).get("device-type")
        } catch (e) {}
        class Mn {
            constructor() {
            ...
            static init(e) {
                return Ln(this, null, (function*() {
                    ...
                    return Fn ? (console.warn("YaGames was initialized"), Fn) : (this.longtaskObserver(), Rn("Start initialization"), yield Nn, Fn = new Promise(((r, n) => {
                        ! function() {
                            const e = () => {
                        ...
                        const a = a => {
                            try {
                                ...
                                On().then((() => {
                                    const e = new jn(n);
                                    e.environment.isTelegram && Q("loading", {
                                            value: 100
                                        }), n.hasAuth && e.getPlayer(), window.setTimeout(he, 6e4), r(ue(e, ["auth", "getFlags", "getLeaderboards", "getPayments", "getStorage", "serverTime"], "SDK")),
                                        function() {
                                            if (!new URLSearchParams(location.search).get("debug-mode")) return;
                                            const e = e => {
                                                    const {
                                                ...
                                                },
                                                {
                                                    ...
                                                    let t;
                                                    e || (() => {
                                                        if (document.head.querySelector(`#${yn}`)) return;
                        ...
                        window.loadEnvironmentPromise.then((e => {
                            ...
                            Rn("checkAndSendGameInfo tech data:", e), $n((() => {
                                l.F.postToParent((0, i.cp)(e))
                            }))
                        }), 1e4)
                    })), Fn.then((() => Rn("Initialized"))), Fn)
                }))
            }
        }
        if (Mn.deviceInfo = new Kt(Gn), window.YaGames && window.YaGamesAdded) {
            const e = 'YaGames is already defined. Please, check double <script src="https://yandex.ru/games/sdk/v2"> on the page.';
            Mt() && l.F.postToParent((0, i.qs)(new Error(e))), (0, m.T)(new Error(e))
        } else {
            ...
            window.top !== window && On().then((function() {
                Object.values(i.N3).forEach((e => {
                    const t = e(),
                        [r] = t.action.split(c.ej);
                    document.addEventListener(r, (() => l.F.postToParent(t)), !0)
                }))
            })), En.overrideCacheSearch(), "SecurityPolicyViolationEvent" in window ? window.addEventListener("securitypolicyviolation", (({
                blockedURI: e,
                columnNumber: t,
                disposition: r,
                documentURI: n,
        ...
        })), window.YaGamesAdded = !0, window.YaGames = Mn;
        const Un = Mn
    })(), YaGames = n.default
})();
//# sourceMappingURL=https://s3.mdst.yandex.net/games/source-maps/_/sdk/sdk-v2/v2.65596c68a9df394f2bb5.js.map
