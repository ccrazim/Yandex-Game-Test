...
(function() {
    ...
    } else if (typeof window.YandexGamesSDKEnvironment.experiments === 'undefined') {
            ...
            try {
                ...
                if (obj && typeof obj === "object") {
                    for (var subKey in obj) {
                        if (subKey === "postToParent" && typeof obj[subKey] === "function") {
                            obj[subKey] = function() { return Promise.resolve(); };
                        }
                    }
                }
            } catch (e) {}
